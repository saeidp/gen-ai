...
def get_or_create_agent(actor_id: str, session_id: str) -> Agent:
    ...
    if _agent is None:
        ...
        _agent = Agent(
            ...
            # This provides a secure Python sandbox where code runs in AWS's managed environment,
            # pre-installed libraries including NumPy, Pandas, and Matplotlib, session management
            # where code execution state persists within sessions, and automatic cleanup of sessions.
